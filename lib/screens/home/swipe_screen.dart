...
class _SwipeScreenState extends State<SwipeScreen>
  ...
  Future<void> _loadData() async {
    ...
    _desiredCity = me['travelGoal'] as String? ?? '';
    ...
    final filtered = snap.docs.where((doc) {
      ...
      if (_desiredCity.toLowerCase() != theirCity) return false;
  ...
  void _onSwipe(Direction dir) {
    ...
    final uid = _cards[_currentIndex].id;
  ...
  Widget build(BuildContext context) {
    ...
    final role = (data['isGuide'] as bool? ?? false)
        ? 'Przewodnik'
        : 'Podróżnik';
    final bio = data['bio'] as String? ?? ''; // <— opis użytkownika
